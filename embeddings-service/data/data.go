...
func GetdataInception() *moviepb.MovieInfo {
	return &moviepb.MovieInfo{
		...
		Year:     2010,
		Genre:    strings.Split("Action|Crime|Drama|Mystery|Sci-Fi|Thriller|IMAX", "|"),
