...
from movie_services import processmovies_pb2 as movie__services_dot_processmovies__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in movie_services/processmovies_pb2_grpc.py depends on'
...
def add_MovieServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'MovieService.MovieService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('MovieService.MovieService', rpc_method_handlers)
